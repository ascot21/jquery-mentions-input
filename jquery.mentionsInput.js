    ...
    var MentionsInput = function (settings) {
      ...
      //Adds mention to mentions collections
        ...
        function onInputBoxInput(e) {
            ...
            var previousChar = inputBuffer[triggerCharIndex - 1]; //Returns the last match of the key pressed before triggerChar
            if (triggerCharIndex > -1) { //If the triggerChar is present in the inputBuffer array
                if (!previousChar || !previousChar.trim()) { //If there is no previous previousChar or the previousChar is a space
